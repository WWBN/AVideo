...
$t['Date'] = "Tarih";
$t['Date Added (".$info[2].")'] = "Tarih Eklendi (".$info[2].")";
$t['Date added (".$info[2].")'] = "Tarih Eklendi (".$info[2].")";
...
$t['Enable WebCam Stream'] = "WebCam Yayınını Etkinleştir";
$t['Enable SMTP'] = "SMTP Etkinleştir";
$t['Enable SMTP Auth'] = "SMTP Yetkisini Etkinleştir";
$t['Encode video and audio'] = "Video ve Ses Kodlama";
...
$t['Next video order']  = "Sonraki video sırası";
$t['No']  = "Hayır";
...
$t['Sort by name (".$info[2].'] = "Ada göre sırala (".$info[2].")";
$t['Sort by name (abc)']  = "Ada göre sırala (abc)";
$t['Source']  = "Kaynak";
$t['Starts on']  = "Başlat";
$t['Status']  = "Durum";
...
$t['You are online now, web cam is disabled'] = "Zaten çevrimiçi durumdasınız, web kamerası devre dışı";
...
$t['Your video <a href=\'https://youtu.be/%s\' target=\'_blank\' class=\'btn btn-default\'><span class=\'fab fa-youtube\'></span> %s</a> was uploaded to your <a href=\'https://www.youtube.com/my_videos\' class=\'btn btn-default\' target=\'_blank\'><span class=\'fab fa-youtube-square\'></span> YouTube Account</a><br> '] = "Videonuz <a href='https://youtu.be/%s' target='_blank' class='btn btn-default'><span class='fab fa-youtube'></span> %s</a>, <a href='https://www.youtube.com/my_videos' class='btn btn-default' target='_blank'><span class='fab fa-youtube-square'></span> YouTube Hesabınıza</a> yüklendi<br> ";
