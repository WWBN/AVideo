...
$t['This page works only with MP4,MP3 and OGG-files, if you have or need any other format, try to install your own <a href=\'https://github.com/WWBN/AVideo-Encoder\' class=\'btn btn-warning btn-xs\'>encoder</a> or use the <a href=\'https://encoder1.avideo.com/\' class=\'btn btn-warning btn-xs\'>public</a> one'] = "Эта страница работает только с файлом MP4, если у вас есть или вам нужен какой-либо другой формат, попробуйте установить свой собственный <a href = 'https: //github.com/WWBN/AVideo-Encoder' class = 'btn btn-warning btn -xs '> encoder </a> или используйте <a href='https://encoder1.avideo.com/' class='btn btn-warning btn-xs'> общедоступный </a>";
