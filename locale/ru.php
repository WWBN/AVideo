...
$t['Download video'] = 'Скачать видео';
$t['Download your videos Sheet'] = 'Скачать список видео';
...
$t['Human Experiments'] = 'Эксперименты на людях';
$t['ID'] = 'ID';
$t['IP'] = 'IP';
...
$t['Only you can see this, because you are a admin.'] = 'Это можете видеть только вы, потому что вы администратор.';
...
$t['If you can not view this video, your browser does not support HTML5 videos'] = 'Если вы не можете просмотреть это видео, ваш браузер не поддерживает видео HTML5';
