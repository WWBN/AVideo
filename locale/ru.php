...
$t['Thank you!'] = 'Спасибо!';
$t['Thank you'] = 'Спасибо';
$t["The <a href='{videoLink}'>{videoName}</a> video was reported as inapropriate from {user} "] = "Видео <a href='{videoLink}'>{videoName}</a> было признано неприемлемым от пользователя {user} ";
...
$t['The regular form to signin will not exist, if you check this will only havesocial login or LDAP option'] = 'Обычная форма для входа будет отключена, если вы установите флажок, в ней будет только опция соц. входа или LDAP';
...
$t['The {videoName} video was reported as inapropriate'] = 'Видео {videoName} было признано неприемлемым';
...
$t['This is useful if you want to use our LDAP plugin or maybe only allowauthentication from Social Networks'] = 'Это полезно, если вы хотите использовать наш плагин LDAP или разрешить аутентификацию только из социальных сетей.';
...
$t["This page works only with MP4,MP3 and OGG-files, if you have or need any other format, try to install your own <a href='https://github.com/DanielnetoDotCom/AVideo-Encoder' class='btn btn-warning btn-xs'>encoder</a> or use the <a href='https://encoder.youphptube.com/' class='btn btn-warning btn-xs'>public</a> one"] = "Эта страница работает только с MP4, MP3 и OGG-файлами, если у вас есть или нужен какой-либо другой формат, попробуйте установить свой <a href='https://github.com/DanielnetoDotCom/AVideo-Encoder' class='btn btn-warning btn-xs'>encoder</a> или используйте <a href='https://encoder.youphptube.com/' class='btn btn-warning btn-xs'>общедоступный</a> кодировщик";
...
$t['Truly customize your AVideo and create a more professional video sharing site experience for your visitors by removing or replacing the footer, aboutpage and Meta Description with your own.'] = 'Настройте платформу и создайте более профессиональный интерфейс сайта для обмена видео для ваших пользователей, удалив или заменив нижний колонтитул, страницу с описанием и мета-описание.';
...
$t['You are hosting %d videos total, %d minutes and %d seconds and consuming %sof disk'] = 'Вы размещаете всего %d видео, %d минут и %d секунд и используете %sof диска';
