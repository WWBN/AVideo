...
$t['We could not notify anyone ({$email}, {$siteOwnerEmail}), but we marked it as inappropriate'] = 'Мы не могли никого уведомить (, ), но мы пометили его как неиспользованное';
$t['We could not notify the video owner {$email}, but we marked it as inappropriate'] = 'Нам не удалось уведомить владельца видео , но мы пометили его как недопустимое';
$t['We could not notify the video owner {$siteOwnerEmail}, but we marked it as inappropriate'] = 'Нам не удалось уведомить владельца видео , но мы пометили его как недопустимое';
