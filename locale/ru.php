...
$t['Autoplay Video on Load Page'] = "Автозапуск видео на странице загрузки";
...
$t['Channel name already exists'] = "азвание канала уже существует";
$t['Channels'] = "Каналы";
$t['Charts'] = "Графики";
...
$t['Copy video URL'] = "Скопируйте URL видео";
...
$t['Do you want to report this video? Sign in to make your opinion count.'] = "Не нравится это видео? Войдите в аккаунт, чтобы оставить мнение.";
$t['Document'] = "Документ";
$t['Donation'] = "Пожертвование";
$t['Donation Link'] = "Ссылка на пожертвование";
$t['Don´t like this video? Sign in to make your opinion count.'] = "е нравится это видео? Войдите в аккаунт, чтобы оставить мнение.";
$t['Down'] = "Вниз";
$t['Download'] = "Скачать";
...
$t['Email All Users'] = "Эл. почта всех пользователей";
...
$t['Get notified for every new video'] = "Получайте уведомления за каждое новое видео";
$t['Go Back'] = "Вернуться";
...
$t['Max Prints'] = "Маусимальная печать";
...
$t['Most'] = "Наиболее";
$t['Most popular'] = "Наиболее популярный";
$t['Most watched'] = "Наиболее просматриваемый";
...
$t['New User Groups'] = "Новые пользователь групп";
$t['Next'] = "Следующий";
...
$t['Send'] = "Послать";
$t['Send Email'] = "Послать эл. сообщение";
$t['Serie'] = "Серия";
...
$t['This page works only with MP4,MP3 and OGG-files, if you have or need any other format, try to install your own <a href=\'https://github.com/WWBN/AVideo-Encoder\' class=\'btn btn-warning btn-xs\'>encoder</a> or use the <a href=\'https://encoder2.avideo.com/\' class=\'btn btn-warning btn-xs\'>public</a> one'] = "Эта страница работает только с файлом MP4, если у вас есть или вам нужен какой-либо другой формат, попробуйте установить свой собственный <a href = 'https: //github.com/WWBN/AVideo-Encoder' class = 'btn btn-warning btn -xs '> encoder </a> или используйте <a href='https://encoder2.avideo.com/' class='btn btn-warning btn-xs'> общедоступный </a>";
...
$t['Upload a Plugin ZIP File'] = "агрузить плагин ZIP-файл";
...
$t['year'] = "год";
$t['years'] = "лет";
$t['youtube-dl uses Python and some servers does not came with python as dafault, to install Python type:'] = "youtube-dl использует Python, и некоторые серверы не поставляются с python по умолчанию, для установки Python:";
