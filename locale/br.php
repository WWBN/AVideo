...
// view/error.php updated 11 sep 2020
$t['We couldn\'t find what you were looking for.'] = "Não encontramos o que está procurando";
$t['Unfortunately the page you were looking for could not be found. It may be temporarily unavailable, moved or no longer exist.'] = "Infelizmente a página que está procurando não foi encontrada. Ela pode estar indisponível temporariamente, alterada de local ou não existe mais.";
$t['Check the URL you entered for any mistakes and try again. Alternatively, search for whatever is missing or take a look around the rest of our site.'] = "Verifique se o endereço informado está correto. Você pode usar a busca do site para procurar o que precisa.";
$t['Home'] = "Início";
