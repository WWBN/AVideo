...
$t['This page works only with MP4,MP3 and OGG-files, if you have or need any other format, try to install your own <a href=\'https://github.com/WWBN/AVideo-Encoder\' class=\'btn btn-warning btn-xs\'>encoder</a> or use the <a href=\'https://encoder2.avideo.com/\' class=\'btn btn-warning btn-xs\'>public</a> one'] = "דף זה פועל רק עם קבצי MP4, MP3 ו- OGG, אם יש לך או צריך פורמט אחר, נסה להתקין את עצמו <a href = 'https: //github.com/DanielnetoDotCom/AVideo-Encoder' class = 'btn btn-btn-xs '> או להשתמש ב <a href='https://encoder2.avideo.com/' class='btn btn-warning btn-xs'> הציבור </a>";
