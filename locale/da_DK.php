...
$t["This page works only with MP4,MP3 and OGG-files, if you have or need any other format, try to install your own <a href='https://github.com/DanielnetoDotCom/AVideo-Encoder' class='btn btn-warning btn-xs'>encoder</a> or use the <a href='https://encoder.youphptube.com/' class='btn btn-warning btn-xs'>public</a> one"] = "Denne side fungerer kun med MP4, MP3 og OGG-filer, hvis du har eller har brug for et andet format, så prøv at installere dit eget <a href='https://github.com/WWBN/AVideo-Encoder' class='btn btn-advarsel btn-xs '> koder </a> eller brug <a href='https://encoder1.wwbn.net/' class='btn btn-advarsel btn-xs'> offentlig </a> en";
