...
$t['We could not notify anyone ({$email}, {$siteOwnerEmail}), but we marked it as inappropriate'] = 'Du kan ikke administrere plugin-logooverlay';
$t['We could not notify the video owner {$email}, but we marked it as inappropriate'] = 'Du kan ikke administrere plugin dette';
$t['We could not notify the video owner {$siteOwnerEmail}, but we marked it as inappropriate'] = 'Du kan ikke administrere plugins';
