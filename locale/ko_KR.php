...
$t['We could not notify anyone ({$email}, {$siteOwnerEmail}), but we marked it as inappropriate'] = '누구에게도 알릴 수 없었지만(, ), 부적합하다고 표시했다.';
$t['We could not notify the video owner {$email}, but we marked it as inappropriate'] = '비디오 소유자 을(를) 알릴 수는 없지만 부적합하다고 표시했다.';
$t['We could not notify the video owner {$siteOwnerEmail}, but we marked it as inappropriate'] = '비디오 소유자 을(를) 알릴 수는 없지만 부적합하다고 표시했다.';
