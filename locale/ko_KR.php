...
$t["This page works only with MP4,MP3 and OGG-files, if you have or need any other format, try to install your own <a href='https://github.com/DanielnetoDotCom/AVideo-Encoder' class='btn btn-warning btn-xs'>encoder</a> or use the <a href='https://encoder.youphptube.com/' class='btn btn-warning btn-xs'>public</a> one"] = '이 페이지는 MP4,MP3 및 OGG 파일에서만 작동하며, 다른 형식이 있거나 필요한 경우 자신의 Public Encoder를 설치하거나 를 사용하십시오.';
