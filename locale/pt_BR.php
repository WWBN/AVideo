...
$t['%s ERROR: You must set an ID on config'] = "%s ERRO: Você deve definir um ID na configuração";
$t['%s ERROR: You must set an ID on config'] = "%s ERROR: Você deve configurar o ID";
