...
$t['We could not notify anyone ({$email}, {$siteOwnerEmail}), but we marked it as inappropriate'] = 'Wir konnten niemanden benachrichtigen (, ), aber wir haben es als unangemessen markiert';
$t['We could not notify the video owner {$email}, but we marked it as inappropriate'] = 'Wir konnten den Videoinhaber nicht benachrichtigen, haben das Video jedoch als nicht geeignet markiert';
$t['We could not notify the video owner {$siteOwnerEmail}, but we marked it as inappropriate'] = 'Wir konnten den Videoinhaber  nicht benachrichtigen, haben das Video jedoch als nicht geeignet markiert';
