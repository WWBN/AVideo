...
$t['Watching Now'] = '正在看';
$t['We could not notify anyone ({$email}, {$siteOwnerEmail}), but we marked it as inappropriate'] = '我們無法通知任何人 (, )，但我們將其標記為不當';
$t['We could not notify the video owner {$email}, but we marked it as inappropriate'] = '我們無法通知視頻所有者 ，但我們將其標記為不當';
$t['We could not notify the video owner {$siteOwnerEmail}, but we marked it as inappropriate'] = '我們無法通知視頻所有者 ，但我們將其標記為不當';
