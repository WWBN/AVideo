...
$t["This page works only with MP4,MP3 and OGG-files, if you have or need any other format, try to install your own <a href='https://github.com/DanielnetoDotCom/AVideo-Encoder' class='btn btn-warning btn-xs'>encoder</a> or use the <a href='https://encoder.youphptube.com/' class='btn btn-warning btn-xs'>public</a> one"] = "此頁面僅適用於 MP4、MP3 和 OGG 文件，如果您有或需要任何其他格式，請嘗試安裝自己的 <a href='https://github.com/WWBN/AVideo-Encoder' class= 'btn btn-warning btn-xs'>編碼器</a> 或使用<a href='https://encoder1.wwbn.net/' class='btn btn-warning btn-xs\ '>公開</a>一個";
