...
$t['We could not notify anyone ({$email}, {$siteOwnerEmail}), but we marked it as inappropriate'] = '指定した方法(, )では、誰にも通知することができませんでしたが、不適切なものとしてマークしました';
$t['We could not notify the video owner {$email}, but we marked it as inappropriate'] = '動画の投稿者に を送ることはできませんが、不適切なものとしてマークしました';
$t['We could not notify the video owner {$siteOwnerEmail}, but we marked it as inappropriate'] = '動画の投稿者に で通知することはできませんでしたが、不適切なものとしてマークしました';
