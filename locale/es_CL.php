...
$t['We could not notify anyone ({$email}, {$siteOwnerEmail}), but we marked it as inappropriate'] = 'No pudimos notificar a nadie (, ), pero lo marcamos como no apropiado';
$t['We could not notify the video owner {$email}, but we marked it as inappropriate'] = 'No pudimos notificar al propietario del video , pero lo marcamos como no apropiado';
$t['We could not notify the video owner {$siteOwnerEmail}, but we marked it as inappropriate'] = 'No pudimos notificar al propietario del video , pero lo marcamos como no apropiado';
