...
$t['This page works only with MP4,MP3 and OGG-files, if you have or need any other format, try to install your own <a href=\'https://github.com/WWBN/AVideo-Encoder\' class=\'btn btn-warning btn-xs\'>encoder</a> or use the <a href=\'https://encoder2.avideo.com/\' class=\'btn btn-warning btn-xs\'>public</a> one'] = "This page works only with MP4,MP3 and OGG-files, if you have or need any other format, try to install your own <a href='https://github.com/WWBN/AVideo-Encoder' class='btn btn-warning btn-xs'>encoder</a> or use the <a href='https://encoder2.avideo.com/' class='btn btn-warning btn-xs'>public</a> one";
...
$t['youtube-dl uses Python and some servers does not came with python as dafault, to install Python type:'] = "youtube-dl 使用 Python 语言写成,有些系统默认不会安装 Python. 要安装 Python 请输入:";
$t['Zip Code'] = "邮政编码";
...
$t['This page works only with a MP4 File, if you have or need any other format, try to install your own <a href=\'https://github.com/WWBN/AVideo-Encoder\' class=\'btn btn-warning btn-xs\'>encoder</a> or use the <a href=\'https://encoder2.avideo.com/\' class=\'btn btn-warning btn-xs\'>public</a> one'] = "此网页仅支持 MP4，如果你需要别的格式，下载并安装你自己的<a href='https://github.com/WWBN/AVideo-Encoder' class='btn btn-warning btn-xs'>编码服务器</a>或使用<a href='https://encoder2.avideo.com/' class='btn btn-warning btn-xs'>公共编码服务器</a>";
