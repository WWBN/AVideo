...
$t['For the best results, please Use this image as a guide to create yourChannel Art'] = 'Aby uzyskać najlepsze rezultaty, proszę użyć tego obrazu jako przewodnika do stworzenia swojego Channel Art';
$t['Format'] = 'Format';
$t['Free'] = 'Bezpłatnie';
...
$t['Json'] = 'Json';
$t['Just a quick note to say a big welcome and an even bigger thank you for registering'] = 'Krótka notatka, aby serdecznie powitać i jeszcze bardziej podziękować za rejestrację';
...
$t['Let users request withdraws from his wallet. the withdraw mus be donemanually'] = 'Pozwól użytkownikom żądać wypłat z jego portfela. wypłaty należy dokonać ręcznie';
$t['Link'] = 'Link';
$t['Links'] = 'Linki';
...
$t['Terms'] = 'Warunki';
$t['Thank you!'] = 'Dziękuję!';
$t["The <a href='{videoLink}'>{videoName}</a> video was reported as inapropriate from {user} "] = "Wideo <a href='{videoLink}'>{videoName}</a> zostało zgłoszone jako niestosowne od {user} ";
...
$t['This is useful if you want to use our LDAP plugin or maybe only allowauthentication from Social Networks'] = 'Jest to przydatne, jeśli chcesz korzystać z naszej wtyczki LDAP lub zezwolić tylko na uwierzytelnianie z sieci społecznościowych';
...
$t["This page works only with MP4,MP3 and OGG-files, if you have or need any other format, try to install your own <a href='https://github.com/DanielnetoDotCom/AVideo-Encoder' class='btn btn-warning btn-xs'>encoder</a> or use the <a href='https://encoder.youphptube.com/' class='btn btn-warning btn-xs'>public</a> one"] = "Ta strona działa tylko z plikami MP4, MP3 i OGG, jeśli masz lub potrzebujesz innego formatu, spróbuj zainstalować swój własny <a href='https://github.com/DanielnetoDotCom/AVideo-Encoder' class='btn btn-warning btn-xs'>enkodera</a> lub użyj <a href='https://encoder.youphptube.com/' class='btn btn-warning btn-xs'>publicznego</a>";
...
$t['You are hosting %d videos total, %d minutes and %d seconds and consuming %sof disk'] = 'Hostujesz łącznie %d filmów, %d minut i %d sekund i zużywasz %sof dysku';
...
// Dodatki (mogą należeć do wtyczki lub mogą być przestarzałe i niepotrzebne; należy potwierdzić).
