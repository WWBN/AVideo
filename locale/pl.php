...
$t['We could not notify anyone ({$email}, {$siteOwnerEmail}), but we marked it as inappropriate'] = 'Nie mogliśmy nikogo powiadomić ({$email}, {$siteOwnerEmail}), ale oznaczyliśmy to jako niewłaściwe';
$t['We could not notify the video owner {$email}, but we marked it as inappropriate'] = 'Nie mogliśmy powiadomić właściciela filmu {$email}, ale oznaczyliśmy go jako niewłaściwy';
$t['We could not notify the video owner {$siteOwnerEmail}, but we marked it as inappropriate'] = 'Nie mogliśmy powiadomić właściciela filmu {$siteOwnerEmail}, ale oznaczyliśmy go jako niewłaściwy';
