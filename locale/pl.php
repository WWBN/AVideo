<?php
global $t;
//------ Language File Avideo ---- by KrzysioMisio  in 29 October 2021
//----------------------------------------------------------------------------------------------------------

$t["Error. Oops you've encountered an error"] = 'Błąd. Ups, wystąpił błąd';
$t["I would humbly like to thank God for giving me the necessary knowledge, motivation, resources and idea to be able to execute this project. Without God's permission this would never be possible."] = 'Pokornie dziękuję Bogu za to, że dał mi niezbędną wiedzę, motywację, zasoby i pomysł na realizację tego projektu. Bez pozwolenia Boga nigdy nie byłoby to możliwe. ';
$t["ID can't be blank"] = 'Identyfikator nie może być pusty';
$t["If you can't view this video, your browser does not support HTML5 videos"] = 'Jeśli nie możesz obejrzeć tego filmu, Twoja przeglądarka nie obsługuje filmów HTML5';
...
$t['As a database increases in size full database backups take more time to complete, and require more storage space. please be patience'] = 'Wraz ze wzrostem rozmiaru bazy danych tworzenie pełnych kopii zapasowych bazy danych zajmuje więcej czasu i wymaga więcej miejsca do magazynowania. proszę zachować cierpliwość';
$t['Attention'] = 'Uwaga';
...
$t['Document'] = 'Dokument';
$t['Donatate from your wallet'] = 'Przekaż darowiznę ze swojego portfela';
...
$t['This page works only with a MP4 File, if you have or need any other format, try to install your own <a href="https://github.com/WWBN/AVideo-Encoder" class="btn btn-warning btn-xs">encoder</a> or use the <a href="https://encoder1.avideo.com/" class="btn btn-warning btn-xs">public</a> one'] = 'Ta strona działa tylko z plikiem MP4, jeśli masz lub potrzebujesz innego formatu, spróbuj zainstalować własny <a href="https://github.com/WWBN/AVideo-Encoder" class="btn btn-warning btn-xs">enkoder</a> lub użyj <a href="https://encoder1.avideo.com/" class="btn btn-warning btn-xs">publicznego</a>';
...
$t['Upload a MP4 video'] = 'Prześlij wideo MP4';
