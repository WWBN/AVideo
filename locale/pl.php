...
$t['This page works only with a MP4 File, if you have or need any other format, try to install your own <a href=\'https://github.com/WWBN/AVideo-Encoder\' class=\'btn btn-warning btn-xs\'>encoder</a> or use the <a href=\'https://encoder2.avideo.com/\' class=\'btn btn-warning btn-xs\'>public</a> one'] = "Ta strona działa tylko z plikiem MP4, jeśli masz lub potrzebujesz innego formatu, spróbuj zainstalować własny <a href='https://github.com/WWBN/AVideo-Encoder' class='btn btn-warning btn-xs'>enkoder</a> lub użyj <a href='https://encoder2.avideo.com/' class='btn btn-warning btn-xs'>publicznego</a>";
