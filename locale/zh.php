...
$t['Watching Now'] = '正在看';
$t['We could not notify anyone ({$email}, {$siteOwnerEmail}), but we marked it as inappropriate'] = 'We could not notify anyone (, ), but we marked it as inappropriate';
$t['We could not notify the video owner {$email}, but we marked it as inappropriate'] = 'We could not notify the video owner , but we marked it as inappropriate';
$t['We could not notify the video owner {$siteOwnerEmail}, but we marked it as inappropriate'] = 'We could not notify the video owner , but we marked it as inappropriate';
