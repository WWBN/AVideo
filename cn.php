...
$t['For faster encode, download your own encoder'] = "追求编码的速度，下载你自己的编码器";
...
$t['Site Configurations'] = "站点配置";
$t['Skip Ad'] = "忽略广告";
$t['Skip Button appears after (X) seconds'] = "忽略按钮将在 (X) 秒后出现";
$t['Sorry'] = "抱歉";
$t['Sorry you not able to download videos right now!'] = "抱歉，你没有下载视频的权利!";
$t['Sorry!'] = "抱歉!";
...
$t['You can not Manage This Video'] = "你不能管理这个视频";
$t['You can not do this'] = "你不能这么操作";
$t['You can not manage ads'] = "你不能管理广告";
$t['You can not manage categories'] = "你不能管理类别";
$t['You can not manage comments'] = "你不能管理留言";
$t['You can not manage plugins'] = "你不能管理插件";
...
$t['You can not manager plugin add logo'] = "你不能管理插件和图标";
...
$t['You can upload max of %s!'] = "最大你可以上传 %s!";
$t['You can use our public encoder on'] = "你可以使用我们的开放编码器";
...
$t['You must be logged'] = "你必须登录";
$t['You must fill all fields'] = "你必须填写所有字段";
...
$t['Your message could not be sent!'] = "你的消息发送失败!";
$t['Your message has been sent!'] = "你的信息已经发送!";
$t['Your new password could not be set!'] = "你的新密码设置失败!";
$t['Your new password has been set!'] = "你的新密码设置成功!";
$t['Your password does not match!'] = "你的密码不匹配!";
...
$t['Your system is up to date'] = "你的系统是最新的";
