...
<html>
    ...
    <body>
        ...
        <script>
            aVideoMeetStart('<?php echo $domain; ?>', '<?php echo $meet->getCleanName(); ?>', '<?php echo Meet::getToken($meet_schedule_id); ?>', '<?php echo User::getEmail_(); ?>', '<?php echo User::getNameIdentification(); ?>', <?php echo json_encode(Meet::getButtons($meet_schedule_id)); ?>);
