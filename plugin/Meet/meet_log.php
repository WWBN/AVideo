        ...
        <div class="panel panel-default" id="roomConfiguration">
            ...
            <div class="panel-body tabbable-line" id="logTabs">
                ...
                <div class="tab-content">
                    ...
                    echo $global['webSiteRootURL'] . 'plugin/Meet/meet_scheduled.php?meet_scheduled=today&manageMeetings=0';
                    ?>"><div class="loader"></div></div>
                    <div id="mUGUpcoming" class="tab-pane fade" style="padding: 10px;" url="<?php
                    echo $global['webSiteRootURL'] . 'plugin/Meet/meet_scheduled.php?meet_scheduled=upcoming&manageMeetings=0';
                    ?>"><div class="loader"></div></div>
                    <div id="mUGPast" class="tab-pane fade" style="padding: 10px;" url="<?php
                         echo $global['webSiteRootURL'] . 'plugin/Meet/meet_scheduled.php?meet_scheduled=past&manageMeetings=0';
                         ?>"><div class="loader"></div></div>
                </div>
            </div>
        </div>
