                        ...
                        "columns": [
                            {
                                ...
                                "render": function (data, type, row) {
                                    ...
                                    if (data == 2) {
                                        ...
                                        return checkbox + '<span style="color:rgba(0,0,0,0.3);" data-toggle="tooltip" title="<?php echo __("Logged Users Only"); ?>" ><i class="fa fa-user"></i><i class="fa fa-lock"></i></span>'
                                    } else {
