...
if (!empty($_REQUEST['newServer'])) {
    $p = AVideoPlugin::loadPluginIfEnabled("Meet");
    $p->setDataObjectParameter("server->value", preg_replace("/[^0-1a-z.]/i", "", $_REQUEST['newServer']));
}
    ...
    <body class="<?php echo $global['bodyClass']; ?>">
        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                <?php if (isset($_REQUEST['super_admin'])) { ?>
                <div class="panel-heading clearfix">

                    <h3>Domain: <?php echo str_replace('https://', '', $domain); ?><h3>
                    <h3>Platform: <?php echo $_SERVER['HTTP_HOST']; ?></h3>

                    <!-- <a href="<?php echo $domain; ?>/platform/administration/avideo/live_meet/"  class="btn btn-default pull-left" data-toggle="tooltip" title="<?php echo __("Create a Meet"); ?> " data-placement="bottom" >
                        <i class="fa fa-comments"></i> <?php echo __("Create a Meet"); ?>
                    </a> -->
                </div>
                <?php } ?>
                                    ...
                                    <div class="panel panel-default" id="panel<?php echo $newKey; ?>">
                                        <div class="panel-heading ">
                                            ...
                                            if ($obj->server->value !== $key) {
                                                ?>
                                                <a href="<?= $_REQUEST['changeServerURL'] ?>&newServer=<?php echo $key; ?>" data-toggle="tooltip" data-placement="bottom" title="Change to (<?php echo $value; ?>) server" >
                                                    <i class="fa fa-random" ></i>
                                                </a>
                                                <?php
                                            } else {
                                                ?>
                                                <a href="<?= $_REQUEST['changeServerURL'] ?>" data-toggle="tooltip" data-placement="bottom" title="Stay on (<?php echo $value; ?>)" >
                                        ...
                                        <div class="panel-body">
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <i class="fa fa-download"></i> Download Speed
                                                ...
                                                <li class="list-group-item">
                                                    <i class="fa fa-upload"></i> Upload Speed
                                                ...
                                                <li class="list-group-item">
                                                    <i class="fa fa-stopwatch"></i> Response Time
                                                ...
                                                <li class="list-group-item">
                                                    <i class="fa fa-network-wired"></i> Sites Active
                                                ...
                                                <li class="list-group-item">
                                                    <i class="fa fa-video"></i> Streamers Services
