...
<div class="form-group col-sm-12">
                                    <label for="PayPalYPT_logagreement_id"><?php echo __("Agreement Id"); ?>:</label>
                                    <select class="form-control input-sm" name="agreement_id" id="PayPalYPT_logagreement_id">
                                        <?php
                                        $options = PayPalYPT_log::getAllAgreement();
...
<div class="form-group col-sm-12">
                                    ...
                                    <select class="form-control input-sm" name="users_id" id="PayPalYPT_logusers_id">
                                        <?php
                                        $options = PayPalYPT_log::getAllUsers();
                                        foreach ($options as $value) {
                                            echo '<option value="'.$value['id'].'">'.$value['id'].'</option>';
                                        }
                                        ?>
...
<div class="form-group col-sm-12">
                                    ...
                                    <select class="form-control input-sm" name="recurring_payment_id" id="PayPalYPT_logrecurring_payment_id">
                                        <?php
                                        $options = PayPalYPT_log::getAllRecurring_payment();
                                        foreach ($options as $value) {
                                            echo '<option value="'.$value['id'].'">'.$value['id'].'</option>';
                                        }
                                        ?>
