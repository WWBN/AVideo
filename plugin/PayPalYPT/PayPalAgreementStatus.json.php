...
//error_log("PayPalAgreementStatus: ".json_encode($agreement->getPlan()->getAgreementDetails()));
$obj->error = false;
...
$obj->msg .= "<br><b>Last Payment: </b>".$agreement->getPlan()->getAgreementDetails()->last_payment_amount->value." ".$agreement->getPlan()->getAgreementDetails()->last_payment_amount->currency;
