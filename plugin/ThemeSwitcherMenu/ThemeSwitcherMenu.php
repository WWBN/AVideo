...
class ThemeSwitcherMenu extends PluginAbstract {
    ...
    public function getHeadCode() {
        ...
        $return = "";
        if(!empty($theme)){
            $return = "<link href=\"{$global['webSiteRootURL']}view/css/custom/{$theme}.css\" rel=\"stylesheet\" type=\"text/css\" id=\"theme\"/>";
        }
        ...
        $return .= '<link href="'.$global['webSiteRootURL'].'view/css/main.css" rel="stylesheet" type="text/css"/>';
