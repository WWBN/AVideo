...
?>
    ...
    <div class="pull-right btn-group" style="display: inline-flex;">
        ...
        ?>
            ...
            <button class="btn btn-xs btn-success" onclick="openVideoSearch(<?php echo $currentSerieVideos_id; ?>)" playlist_id="<?php echo $program['id']; ?>" data-toggle="tooltip" title="<?php echo __('Add to Program'); ?>"><span class="fas fa-cog"></span> <span class="hidden-xs hidden-sm"><?php echo __("Encode"); ?></span></button>
            <button class="btn btn-xs btn-success" onclick="encodeNewVideo()" playlist_id="<?php echo $program['id']; ?>" data-toggle="tooltip" title="<?php echo __('Encode a new video'); ?>"><i class="fas fa-plus"></i> <span class="hidden-xs hidden-sm"><?php echo __("Add"); ?></span></button>
