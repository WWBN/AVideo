            ...
            <ul class="nav nav-tabs">
                ...
                <li class="pull-right ">
                    <form class="navbar-form form-inline input-group" role="search" id="searchFormPlaylist" method="get">
                        <input type="search" id="searchPlaylist" name="searchPlaylist" placeholder="<?php echo __('Search Playlist'); ?>" class="form-control" value="<?php echo addcslashes(strip_tags(@$_REQUEST['searchPlaylist']), '"'); ?>" autocomplete="off">
