...
class CombineSitesGet extends ObjectYPT {

    protected $id, $combine_sites_id, $users_id, $categories_id, $playlists_id, $sort_order, $status;
    ...
    static function getTableName() {
        return 'combine_sites_get_elements';
    }
    ...
    static function addChannel($combine_sites_id, $users_id, $status) {
        ...
        if($c){
            $o = new CombineSitesGet($c['id']);
        }else{
            $o = new CombineSitesGet();
