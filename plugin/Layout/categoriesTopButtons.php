...
<center>
    <ul class="nav nav-tabs nav-tabs-horizontal categoriesTobButtons" >
        ...
        for($i=0;$i<100;$i++){ ?> <li data-toggle="tooltip" title="<?php echo __($i); ?>" data-placement="bottom"> <a href="#"> <?php echo '<i class="fa fa-folder"></i>  <span class="hidden-xs">' . $i . '</span>'; if (!empty($obj->categoriesTopButtonsShowVideosCount)) { echo ' <span class="badge">' . $i . '</span>'; } ?> </a> </li> <?php } ?>
    </ul>
</center>