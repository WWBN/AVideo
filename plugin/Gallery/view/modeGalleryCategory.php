...
if (empty($currentCat)) {
    ...
    $categories = array(Category::getCategoryByName($_GET['catName']));
}
...
<p class="pagination">
    <a class="pagination__next" href="<?php echo $global['webSiteRootURL']; ?>plugin/Gallery/view/modeGalleryCategory.php?tags_id=<?php echo intval(@$_GET['tagsid']); ?>&catName=<?php echo @$currentCat; ?>&search=<?php echo htmlentities(urlencode(getSearchVar())); ?>&current=<?php echo count($categories) ? $_REQUEST['current'] + 1 : $_REQUEST['current']; ?>"></a>
</p>