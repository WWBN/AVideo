        ...
        ?>
                <div class="aspectRatio16_9">
                   ...
                   <?php if (!empty($imgGif) && empty($_REQUEST['noImgGif'])) { ?>
                        <img src="<?php echo getURL('img/loading-gif.pngimg/loading-gif.png'); ?>" data-src="<?php echo $imgGif; ?>" style="position: absolute; top: 0; display: none;" alt="<?php echo htmlentities($value['title']); ?>" id="thumbsGIF<?php echo $value['id']; ?>" class="thumbsGIF img-responsive <?php echo $img_portrait; ?>  rotate<?php echo $value['rotation']; ?>" height="130" />
                    <?php } ?>
                    <?php
