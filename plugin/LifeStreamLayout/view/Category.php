    ...
    if (($obj->SubCategorys) && (!empty($_GET['catName']))) {
        ...
        if ((!empty($childCategories)) && ((($currentCat['parentId'] != "0") || ($currentCat['parentId'] != "-1")))) {
            ...
            <div class="clear clearfix">
                <h3 class="LifeStreamLayoutTitle"><i class="glyphicon glyphicon-download"></i>
                    <?php echo __("Sub-Category-LifeStreamLayout"); ?>
                ...
                <div class="row">
                    ...
                    foreach ($childCategories as $cat) {
                        ...
                        unset($_GET['catName']);
                        ?>
                        <div class="col-lg-2 col-md-4 col-sm-4 col-xs-6 LifeStreamLayoutVideo thumbsImage fixPadding">
                                ...
                                <div class="aspectRatio16_9">
                                    ...
                                    if (!empty($videos)) {
                                        foreach ($videos as $value) {
                                            ...
                                            <?php if ((!empty($imgGif)) && (!$o->LiteLifeStreamLayoutNoGifs)) { ?>
