...
class Google_Service_Container_Resource_ProjectsZonesOperations extends Google_Service_Resource
{
   ...
   * Engine [zone](/compute/docs/zones#available) in which the operation resides.
   * This field has been deprecated and replaced by the name field.
   * @param string $operationId Required. Deprecated. The server-assigned `name`
   * of the operation. This field has been deprecated and replaced by the name
   * field.
   ...
   * @param string $zone Required. Deprecated. The name of the Google Compute
   * Engine [zone](/compute/docs/zones#available) to return operations for, or `-`
