        ...
        <div id="menu1" class="tab-pane fade">
            <div class="list-group-item">
                <div class="panel panel-default">
                    <div class="panel-heading"><a href="https://www.avideo.com/plugins/" class="btn btn-default btn-xs"><i class="fa fa-plug"></i> Plugin Store </a></div>
    ...
    <li class="list-group-item hidden col-md-3" id="pluginStoreListModel">
        ...
        <div class="panel panel-warning panel-sm">
            ...
            <div class="panel-footer">
                <a href="https://www.avideo.com/plugins/" class="btn btn-success btn-xs" role="button"><i class="fa fa-cart-plus"></i> <?php echo __("Buy This Plugin"); ?> </a>
            </div>
        </div>
    </li>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            url: 'https://www.avideo.com/plugins/plugins.json?jsonp=1',
            dataType: 'jsonp',
            success: function (response) {
