                ...
                <div class="panel-body">
                    ...
                    if (empty($custom)) {
						...
						<div style="text-align: center">
							...
							<h1>AVideo Platform</h1>
						</div>						
                        <h2><?php echo __("I would humbly like to thank God for giving me the necessary knowledge, motivation, resources and idea to be able to execute this project. Without God's permission this would never be possible."); ?></h2>
