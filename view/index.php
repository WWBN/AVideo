...
if (version_compare(PHP_VERSION, '7.2') < 0){
  die('YOu are runing PHP version: '.PHP_VERSION.'<br>Please Update your PHP version to 7.2 or above. (7.3 is recommended)<br><h5>For Ubuntu 16</h5>sudo add-apt-repository ppa:jczaplicki/xenial-php74-temp<br>sudo apt-get update');
}
