                ...
                <div class="col-xs-12 col-sm-12 col-lg-3">
                    ...
                    <div class="alert alert-warning">
                        <h1>
                            ...
                            <?php echo __("This page works only with MP4,MP3 and OGG-files, if you have or need any other format, try to install your own <a href='https://github.com/WWBN/AVideo-Encoder' class='btn btn-warning btn-xs'>encoder</a> or use the <a href='https://encoder.avideo.com/' class='btn btn-warning btn-xs'>public</a> one"); ?>
                        </h1>
                    </div>
                    <?php
