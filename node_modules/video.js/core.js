...
class Component {
  ...
  handleKeyDown(event) {
    if (this.player_) {
      ...
      if (!keycode__default["default"].isEventKey(event, 'Tab') && !(this.player_.options_.playerOptions.spatialNavigation && this.player_.options_.playerOptions.spatialNavigation.enabled)) {
        event.stopPropagation();
      }
...
class SpatialNavigation extends EventTarget {
  ...
  onKeyDown_(event) {
    ...
    if (keycode__default["default"].isEventKey(actualEvent, 'left') || keycode__default["default"].isEventKey(actualEvent, 'up') || keycode__default["default"].isEventKey(actualEvent, 'right') || keycode__default["default"].isEventKey(actualEvent, 'down')) {
      // Handle directional navigation
      if (this.isPaused_) {
        return;
      }
      actualEvent.preventDefault();
      const direction = keycode__default["default"](actualEvent);
      this.move(direction);
  ...
  */
  ...
  handleKeyDown(event) {
    ...
    if (spatialNavEnabled) {
      if (horizontalSeek && keycode__default["default"].isEventKey(event, 'Left') || !horizontalSeek && keycode__default["default"].isEventKey(event, 'Down')) {
        event.preventDefault();
        event.stopPropagation();
        this.stepBack();
      } else if (horizontalSeek && keycode__default["default"].isEventKey(event, 'Right') || !horizontalSeek && keycode__default["default"].isEventKey(event, 'Up')) {
        event.preventDefault();
        event.stopPropagation();
        this.stepForward();
      } else {
    ...
    } else if (keycode__default["default"].isEventKey(event, 'Left') || keycode__default["default"].isEventKey(event, 'Down')) {
      event.preventDefault();
      event.stopPropagation();
      this.stepBack();
...
class MenuButton extends Component {
  ...
  handleKeyDown(event) {
    ...
    } else if ((keycode__default["default"].isEventKey(event, 'Up') || keycode__default["default"].isEventKey(event, 'Down')) && !(this.player_.options_.playerOptions.spatialNavigation && this.player_.options_.playerOptions.spatialNavigation.enabled)) {
      if (!this.buttonPressed_) {
        event.preventDefault();
        this.pressButton();
      }
