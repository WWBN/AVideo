...
class TimelineGrid extends internal_cjs.DateComponent {
    ...
    render() {
        ...
        let { options } = context;
        let { dateProfile, tDateProfile } = props;
        let { unit: timerUnit, value: timerUnitValue } = internal_cjs.greatestDurationDenominator(tDateProfile.slotDuration);
        return (preact_cjs.createElement("div", { className: "fc-timeline-body", ref: this.handeEl, style: {
                minWidth: props.tableMinWidth,
                height: props.clientHeight,
                width: props.clientWidth,
            } },
            preact_cjs.createElement(internal_cjs.NowTimer, { unit: timerUnit, unitValue: timerUnitValue }, (nowDate, todayRange) => (preact_cjs.createElement(preact_cjs.Fragment, null,
