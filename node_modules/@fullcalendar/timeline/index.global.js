/*!
FullCalendar Timeline Plugin v6.1.19
    ...
    */
    ...
    class TimelineHeader extends internal$1.BaseComponent {
        ...
        render() {
            ...
            let { unit: timerUnit, value: timerUnitValue } = internal$1.greatestDurationDenominator(props.tDateProfile.slotDuration);
            // WORKAROUND: make ignore slatCoords when out of sync with dateProfile
            let slatCoords = props.slatCoords && props.slatCoords.dateProfile === props.dateProfile ? props.slatCoords : null;
            return (preact.createElement(internal$1.NowTimer, { unit: timerUnit, unitValue: timerUnitValue }, (nowDate, todayRange) => (preact.createElement("div", { className: "fc-timeline-header", ref: this.rootElRef },
    ...
    class TimelineGrid extends internal$1.DateComponent {
        ...
        render() {
            ...
            let { options } = context;
            let { dateProfile, tDateProfile } = props;
            let { unit: timerUnit, value: timerUnitValue } = internal$1.greatestDurationDenominator(tDateProfile.slotDuration);
            return (preact.createElement("div", { className: "fc-timeline-body", ref: this.handeEl, style: {
                    minWidth: props.tableMinWidth,
                    height: props.clientHeight,
                    width: props.clientWidth,
                } },
                preact.createElement(internal$1.NowTimer, { unit: timerUnit, unitValue: timerUnitValue }, (nowDate, todayRange) => (preact.createElement(preact.Fragment, null,
