...
class InterconnectGroups extends \Google\Service\Resource
{
  ...
  {
    $params = ['project' => $project, 'interconnectGroup' => $interconnectGroup, 'postBody' => $postBody];
    $params = array_merge($params, $optParams);
    return $this->call('createMembers', [$params], Operation::class);
  }
  /**
  ...
  {
    $params = ['project' => $project, 'interconnectGroup' => $interconnectGroup];
    $params = array_merge($params, $optParams);
  ...
  public function get($project, $interconnectGroup, $optParams = [])
  {
    $params = ['project' => $project, 'interconnectGroup' => $interconnectGroup];
    $params = array_merge($params, $optParams);
    return $this->call('get', [$params], InterconnectGroup::class);
  }
  /**
  ...
  public function getOperationalStatus($project, $interconnectGroup, $optParams = [])
  {
    $params = ['project' => $project, 'interconnectGroup' => $interconnectGroup];
    $params = array_merge($params, $optParams);
    return $this->call('getOperationalStatus', [$params], InterconnectGroupsGetOperationalStatusResponse::class);
  }
  /**
  ...
  public function listInterconnectGroups($project, $optParams = [])
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', [$params], InterconnectGroupsListResponse::class);
  }
  /**
...
class_alias(InterconnectGroups::class, 'Google_Service_Compute_Resource_InterconnectGroups');
