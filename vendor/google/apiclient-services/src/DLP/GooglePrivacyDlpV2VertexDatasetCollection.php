...
class GooglePrivacyDlpV2VertexDatasetCollection extends \Google\Model
{
  ...
  {
    $this->vertexDatasetRegexes = $vertexDatasetRegexes;
  }
  /**
  ...
  {
    return $this->vertexDatasetRegexes;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GooglePrivacyDlpV2VertexDatasetCollection::class, 'Google_Service_DLP_GooglePrivacyDlpV2VertexDatasetCollection');
