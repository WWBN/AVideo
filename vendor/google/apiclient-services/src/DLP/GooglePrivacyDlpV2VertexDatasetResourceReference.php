...
class GooglePrivacyDlpV2VertexDatasetResourceReference extends \Google\Model
{
  ...
  {
    return $this->datasetResourceName;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GooglePrivacyDlpV2VertexDatasetResourceReference::class, 'Google_Service_DLP_GooglePrivacyDlpV2VertexDatasetResourceReference');
