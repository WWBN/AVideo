...
class CloudAiNlLlmProtoServiceUsageMetadata extends \Google\Model
{
  /**
   * @var int
   */
...
class_alias(CloudAiNlLlmProtoServiceUsageMetadata::class, 'Google_Service_Aiplatform_CloudAiNlLlmProtoServiceUsageMetadata');
