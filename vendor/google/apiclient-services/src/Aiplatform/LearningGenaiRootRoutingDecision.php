...
class LearningGenaiRootRoutingDecision extends \Google\Model
{
  ...
  /**
   * @param LearningGenaiRootRoutingDecisionMetadata
   */
  public function setMetadata(LearningGenaiRootRoutingDecisionMetadata $metadata)
  {
...
class_alias(LearningGenaiRootRoutingDecision::class, 'Google_Service_Aiplatform_LearningGenaiRootRoutingDecision');
