...
class LearningGenaiRootToxicityResult extends \Google\Collection
{
  ...
  /**
   * @param LearningGenaiRootToxicitySignal[]
   */
  ...
  /**
   * @return LearningGenaiRootToxicitySignal[]
   */
...
class_alias(LearningGenaiRootToxicityResult::class, 'Google_Service_Aiplatform_LearningGenaiRootToxicityResult');
