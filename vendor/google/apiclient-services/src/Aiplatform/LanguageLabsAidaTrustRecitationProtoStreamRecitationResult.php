...
class LanguageLabsAidaTrustRecitationProtoStreamRecitationResult extends \Google\Collection
{
   ...
   * @param int
   */
  public function setFullyCheckedTextIndex($fullyCheckedTextIndex)
  {
   ...
   * @return int
   */
  public function getFullyCheckedTextIndex()
  {
    return $this->fullyCheckedTextIndex;
  }
  /**
   * @param string
   */
...
class_alias(LanguageLabsAidaTrustRecitationProtoStreamRecitationResult::class, 'Google_Service_Aiplatform_LanguageLabsAidaTrustRecitationProtoStreamRecitationResult');
