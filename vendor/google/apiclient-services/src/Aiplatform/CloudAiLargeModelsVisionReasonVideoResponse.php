...
class CloudAiLargeModelsVisionReasonVideoResponse extends \Google\Collection
{
  ...
  /**
   * @param CloudAiLargeModelsVisionReasonVideoResponseTextResponse[]
   */
...
class_alias(CloudAiLargeModelsVisionReasonVideoResponse::class, 'Google_Service_Aiplatform_CloudAiLargeModelsVisionReasonVideoResponse');
