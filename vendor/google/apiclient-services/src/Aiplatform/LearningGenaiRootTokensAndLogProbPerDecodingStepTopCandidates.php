...
class_alias(LearningGenaiRootTokensAndLogProbPerDecodingStepTopCandidates::class, 'Google_Service_Aiplatform_LearningGenaiRootTokensAndLogProbPerDecodingStepTopCandidates');
