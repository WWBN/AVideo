...
class GoogleCloudAssuredworkloadsV1UpdateDetails extends \Google\Model
{
  ...
  {
    return $this->orgPolicyUpdate;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudAssuredworkloadsV1UpdateDetails::class, 'Google_Service_Assuredworkloads_GoogleCloudAssuredworkloadsV1UpdateDetails');
