...
class ShoppingWebentityShoppingAnnotationProductImage extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(ShoppingWebentityShoppingAnnotationProductImage::class, 'Google_Service_Contentwarehouse_ShoppingWebentityShoppingAnnotationProductImage');
