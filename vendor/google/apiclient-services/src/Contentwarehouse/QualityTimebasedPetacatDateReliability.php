...
class QualityTimebasedPetacatDateReliability extends \Google\Model
{
  /**
   * @var float
   */
...
class_alias(QualityTimebasedPetacatDateReliability::class, 'Google_Service_Contentwarehouse_QualityTimebasedPetacatDateReliability');
