...
class GoogleCloudContactcenterinsightsV1alpha1BulkDeleteFeedbackLabelsMetadata extends \Google\Collection
{
  ...
  /**
   * @param GoogleCloudContactcenterinsightsV1alpha1BulkDeleteFeedbackLabelsRequest
   */
...
class_alias(GoogleCloudContactcenterinsightsV1alpha1BulkDeleteFeedbackLabelsMetadata::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1alpha1BulkDeleteFeedbackLabelsMetadata');
