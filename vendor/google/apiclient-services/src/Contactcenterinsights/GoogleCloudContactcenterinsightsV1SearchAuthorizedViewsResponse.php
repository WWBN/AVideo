...
class_alias(GoogleCloudContactcenterinsightsV1SearchAuthorizedViewsResponse::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1SearchAuthorizedViewsResponse');
