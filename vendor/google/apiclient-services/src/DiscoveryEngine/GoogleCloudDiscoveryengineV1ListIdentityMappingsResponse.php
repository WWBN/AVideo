...
class_alias(GoogleCloudDiscoveryengineV1ListIdentityMappingsResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1ListIdentityMappingsResponse');
