...
class_alias(GoogleCloudDiscoveryengineV1ImportIdentityMappingsRequestInlineSource::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1ImportIdentityMappingsRequestInlineSource');
