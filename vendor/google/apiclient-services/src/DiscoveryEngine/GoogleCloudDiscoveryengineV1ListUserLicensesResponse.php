...
class_alias(GoogleCloudDiscoveryengineV1ListUserLicensesResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1ListUserLicensesResponse');
