...
class_alias(GoogleCloudDiscoveryengineV1betaSearchRequestDisplaySpec::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaSearchRequestDisplaySpec');
